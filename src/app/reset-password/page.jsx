...
export default function ResetPasswordPage() {
  ...
  const [ready, setReady] = useState(null) // null=checking, true=has recovery session, false=no session
  ...
  // The /auth/callback step exchanged the recovery code for a session before landing here.
  useEffect(() => {
